(() => {
  window.CategoryPage = function CategoryPage({ categoryId, pathPrefix }) {
    ...
    return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(window.SiteHeader, { pathPrefix: prefix, currentCategoryId: categoryId }), /* @__PURE__ */ React.createElement("div", { style: { background: accent.soft, minHeight: "100vh" } }, /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: "hero-formula", style: { display: "flex", flexDirection: "column", gap: 4, alignItems: "center", marginBottom: 16 } }, /* @__PURE__ */ React.createElement("div", { className: "hero-formula__line", style: { whiteSpace: "nowrap", fontWeight: 900, lineHeight: 1.1 } }, /* @__PURE__ */ React.createElement("span", { style: { color: accent.c } }, formula.a), /* @__PURE__ */ React.createElement("span", { style: { margin: "0 .15em", opacity: 0.55 } }, "\xD7"), /* @__PURE__ */ React.createElement("span", null, formula.b)), /* @__PURE__ */ React.createElement("div", { className: "hero-formula__line", style: { whiteSpace: "nowrap", fontWeight: 900, lineHeight: 1.1 } }, /* @__PURE__ */ React.createElement("span", { style: { margin: "0 .15em", opacity: 0.55 } }, "="), /* @__PURE__ */ React.createElement("span", { style: { color: accent.c } }, formula.c))),
      /* @__PURE__ */ React.createElement("div", { style: { fontSize: 16, fontWeight: 700, marginBottom: 8 } }, story.tagline),
      /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, opacity: 0.85, whiteSpace: "pre-line" } }, story.intro)
