(() => {
  ...
  window.SiteFooter = ({ pathPrefix = "", currentCategoryId }) => {
    ...
    return /* @__PURE__ */ React.createElement("footer", { style: {
      ...
      fontSize: 11,
      opacity: 0.8
    } }, /* @__PURE__ */ React.createElement("a", { href: `${pathPrefix}index.html`, style: { color: "inherit", textDecoration: "none" } }, f.nav_home), /* @__PURE__ */ React.createElement("a", { href: `${pathPrefix}index.html#lineup`, style: { color: "inherit", textDecoration: "none" } }, f.nav_apps), /* @__PURE__ */ React.createElement("a", { href: `${pathPrefix}blog/index.html`, style: { color: "inherit", textDecoration: "none" } }, f.nav_blog || "Blog"), f.nav_privacy && /* @__PURE__ */ React.createElement("a", { href: `${pathPrefix}../privacy-policy/`, style: { color: "inherit", textDecoration: "none" } }, f.nav_privacy), /* @__PURE__ */ React.createElement("span", { style: { opacity: 0.5, fontSize: 10 } }, "\xB7"), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, opacity: 0.5, letterSpacing: 0.3 } }, f.copy)));
  };
