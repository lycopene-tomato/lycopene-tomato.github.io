/* ============================================================
 * content/es-ES/record.js — Spanish (Spain): Log category
 * ============================================================ */
window.__CONTENT__ = window.__CONTENT__ || {};
window.__CONTENT__["es-ES"] = window.__CONTENT__["es-ES"] || {};
window.__CONTENT__["es-ES"].categories = window.__CONTENT__["es-ES"].categories || {};

window.__CONTENT__["es-ES"].categories.record = {
  id: "record",
  name: "Serie Log",
  ...
  story: {
    ...
    empathy: {
      ...
      tried: [
        ...
        "Las notas del móvil cuesta organizarlas.",
