  ...
  apps: [
    {
      ...
      setupSteps: [
        { title: "Open the app and do one", desc: "Start with the easy ones. A puzzle takes about a minute — fits the time you’re waiting for coffee to brew." },
        { title: "Solve it, go to the next", desc: "Stuck? Drop it. You can pick up wherever you left off." },
        { title: "When it gets hard, stop", desc: "Difficulty rises gradually. You decide where to call it a day." },
      ],
    },
  ],
};
