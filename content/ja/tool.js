...
window.__CONTENT__.ja.categories.tool = {
  ...
  seoTitle: "後回し対策の視覚タイマーと残り時間アプリ",
  seoDesc: "「あとで」を「今」に変えるタイマー系のラインナップ。子供が自分で打ち上げる惑星タイマーと、子供と過ごせる残り時間のカウントダウンがあります。",
  ...
  apps: [
    {
      ...
      seoTitle: "切り替えが苦手な子の、自分で打ち上げる惑星タイマー",
      seoDesc: "休憩時間を子供が自分で惑星として打ち上げる視覚タイマー。勝手に数字が減っていく理不尽がないから、鳴った後の喧嘩が減る。水星〜海王星、距離で時間を選ぶ設計です。",
      call: [
        "ちょっと、休む？",
        "もう一回、打ち上げる？",
      ],
    ...
    },
    {
      ...
      seoTitle: "子供と過ごせる残り時間のカウントダウン",
      seoDesc: "年齢と卒業から、子供と一緒にいられる残りの日数を計算してホーム画面に出すアプリ。「子育てなんて一瞬よ」を実際の数字にすると、今日の見え方が少し変わります。SNSシェア機能つき。",
      call: [
        "あと、何回？",
        "今日は、何を一緒にした？",
      ],
