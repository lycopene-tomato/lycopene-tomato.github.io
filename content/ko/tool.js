...
window.__CONTENT__.ko.categories.tool = {
  ...
  seoTitle: "미루는 아이를 위한 시각 타이머와 카운트다운",
  seoDesc: "『이따가』를 『지금』으로 바꾸는 타이머 시리즈: 아이가 직접 행성을 발사하는 시각 타이머와, 아이와 함께할 남은 날의 카운트다운.",
  ...
  apps: [
    {
      ...
      seoTitle: "시간 끝나면 무너지는 아이를 위한 시각 타이머",
      seoDesc: "휴식 시간을 아이가 직접 행성으로 발사하는 시각 타이머. 마음대로 줄어드는 숫자가 없으니, 끝나는 순간도 아이가 동의한 끝이 됩니다. 수성부터 해왕성까지 거리로 시간을 고르고, 명왕성은 ∞ 챌린지.",
      call: [
        "잠깐, 쉴까?",
        "한 번 더 발사해 볼까?",
      ],
    ...
    },
    {
      ...
      seoTitle: "아이와 함께할 남은 시간 카운트다운",
      seoDesc: "나이와 졸업 시기로 아이와 함께할 남은 날을 계산해 홈 화면에 띄웁니다. 『애 키우는 거 금방이야』가 실제 숫자가 되면, 오늘이 조금 다르게 보여요. 공유 이미지 기능 포함.",
      call: [
        "앞으로 몇 번?",
        "오늘, 같이 뭐 했지?",
      ],
