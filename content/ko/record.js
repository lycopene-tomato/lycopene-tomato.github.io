...
window.__CONTENT__.ko.categories.record = {
  ...
  story: {
    ...
    empathy: {
      ...
      pivot: "매일 가장 가까이에서 지켜보는 건 나인데,\n어제와 오늘이 어떻게 다른지 떠오르지 않는다.",
      idea_label: "그래서 생각했다.",
      idea: "기억에 의지하지 말고, 기록으로 바꿔 보면,\n「또」 속의 작은 변화가 보이지 않을까?",
    },
  },
  ...
  apps: [
    ...
    },
    {
      ...
      trick: [
        "양치질・숙제 같은 할 일을 원탭으로 기록. 매일의 점 위에 7일 이동 평균 선이 흘러요. 파도가 있어도 선은 천천히 우상향.",
        "할 일은 「기본・필수・가능하면」 3 카테고리 × 3 단계 (완료/시도/안 함). 아이의 기분도 하루 1탭, 「전체」 버튼으로 바쁜 아침도 한 번에 입력.",
        "미입력일은 전날 점수를 이어받아서, 주 1회 학원도 1주일분으로 정확히 평가. 그래프 위에는 데이터에서 읽어낸 코멘트가 자동 표시.",
      ],
      setupSteps: [
        { title: "할 일을 3 카테고리로 나누기", desc: "기본 (양치질・목욕), 필수 (숙제・내일 준비), 가능하면 (자율 학습・독서). 우선 이 분류만 해 두면 돼요." },
        { title: "매일 탭으로 3 단계 기록", desc: "완료 (초록)・시도 (노랑)・안 함 (빨강)을 탭할 뿐. 그날의 합계가 그래프의 점이 돼요." },
        { title: "점이 아니라 이동 평균 선을 보기", desc: "「오늘은 망했다」 싶은 날에도 7일 이동 평균 선은 위를 향해요. 야단치기 전에, 선을 한 번." },
      ],
    },
  ],
};
